...
class Rose {
  ...
  void _cleanUp(int exitCode) {
    ...
    _state._setValue(
        exitCode == 0 ? RoseState.disposed : RoseState.error);
...
///
/// This method is different from the factory method [Rose] that
...
class _RoseState extends ChangeNotifier
    implements ValueListenable<RoseState> {
